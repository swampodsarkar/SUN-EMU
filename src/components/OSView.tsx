...
import { X, Minus, Square, Gamepad2, PlaySquare, Calculator, FileText, Monitor, LayoutGrid, Search, Volume2, Wifi, Folder, Smartphone, RefreshCw, Settings, Image, FolderPlus, MonitorSmartphone, ChevronRight } from 'lucide-react';
...
export default function OSView() {
  ...
  const [windows, setWindows] = useState([
    ...
    { id: 'emulator', title: 'Sun Emulator', icon: Gamepad2, isOpen: false, isMinimized: false, zIndex: 3 },
    { id: 'ads', title: 'Watch Ad to Earn', icon: PlaySquare, isOpen: false, isMinimized: false, zIndex: 4 },
    { id: 'calc', title: 'Calculator', icon: Calculator, isOpen: false, isMinimized: false, zIndex: 5 },
    { id: 'notepad', title: 'Notepad', icon: FileText, isOpen: false, isMinimized: false, zIndex: 6 },
  ]);
